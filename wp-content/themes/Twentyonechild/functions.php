<?php
/*Ce fichier fait partie deTwentyonechild, twentytwentyone child theme.
...
if ( ! function_exists( 'suffice_child_enqueue_child_styles' ) ) {
	function Twentyonechild_enqueue_child_styles() {
...
add_action( 'wp_enqueue_scripts', 'Twentyonechild_enqueue_child_styles' );
