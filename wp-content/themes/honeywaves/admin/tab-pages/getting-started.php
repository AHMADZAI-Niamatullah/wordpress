		...
		<div class="row">
			...
			<div class="col-md-6"> 
				<div class="honeywaves-tab-pane-half honeywaves-tab-pane-first-half">
					...
					<a href="<?php echo esc_url('https://demo.spicethemes.com/?theme=HoneyWaves%20Pro'); ?>" target="_blank"  class="info-block"><div class="dashicons dashicons-book-alt info-icon"></div>
